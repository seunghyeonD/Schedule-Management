      ...
      <section className="space-y-8">
        ...
        <article>
          ...
          <ol className="mt-2 list-decimal space-y-1 pl-5">
            ...
            <li>&ldquo;콘텐츠&rdquo;: 회원이 서비스 내에 입력·업로드·생성한 매장 정보, 방문 기록, 지역 설정 등 일체의 데이터.</li>
          </ol>
        </article>
          ...
          <ol className="mt-2 list-decimal space-y-1 pl-5">
            <li>운영자는 회원에게 다음 각 호의 기능을 제공합니다.
              <ul className="mt-1 list-disc space-y-1 pl-5">
                ...
                <li>방문 일정의 등록·조회·수정·삭제</li>
                <li>지역 그룹 자동 매칭 및 브랜드별 분류</li>
                <li>Google Sheets로의 기록 동기화 (회원이 권한을 부여한 경우)</li>
        ...
        <article>
          ...
          <ol className="mt-2 list-decimal space-y-1 pl-5">
            <li>회원이 서비스에 등록·업로드한 콘텐츠(매장 정보, 방문 기록 등)에 대한 권리는 회원에게 귀속합니다.</li>
            <li>회원은 운영자가 서비스 제공·유지를 위한 목적으로만 콘텐츠를 저장·표시·처리하는 것에 동의합니다. 운영자는 해당 콘텐츠를 회원의 사전 동의 없이 제3자에게 공개하거나 목적 외로 이용하지 않습니다.</li>
            <li>Google Sheets로 동기화된 파일은 회원의 Google Drive에 저장되며, 해당 파일에 대한 모든 권리와 관리 책임은 회원에게 있습니다.</li>
          </ol>
        </article>
        ...
        <article>
          ...
          <ol className="mt-2 list-decimal space-y-1 pl-5">
            ...
            <li>이용계약이 해지되는 경우, 운영자는 관계 법령이 정한 보관 기간을 제외하고 회원의 개인정보 및 서비스 데이터를 지체 없이 파기합니다. 회원 본인의 Google Drive에 저장된 파일은 운영자가 임의로 삭제하지 않습니다.</li>
          </ol>
        </article>
